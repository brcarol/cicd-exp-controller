...
import (
	versionedscheme "cicd-exp-controller/pkg/client/clientset/versioned/scheme"
	client "cicd-exp-controller/pkg/client/injection/client"
	repository "cicd-exp-controller/pkg/client/injection/informers/apis/v1alpha1/repository"
	context "context"
	fmt "fmt"
	reflect "reflect"
	strings "strings"
...
const (
	defaultControllerAgentName = "repository-controller"
	defaultFinalizerName       = "repositories.ecr.services.k8s.aws"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := repositoryInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "ecr.services.k8s.aws.Repository"),
	)
