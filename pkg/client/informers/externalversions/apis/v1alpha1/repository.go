...
import (
	...
	internalinterfaces "cicd-exp-controller/pkg/client/informers/externalversions/internalinterfaces"
	apisv1alpha1 "cicd-exp-controller/pkg/client/listers/apis/v1alpha1"
	context "context"
	time "time"

	ecrcontrollerapisv1alpha1 "github.com/aws-controllers-k8s/ecr-controller/apis/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EcrV1alpha1().Repositories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EcrV1alpha1().Repositories(namespace).Watch(context.TODO(), options)
			},
		},
		&ecrcontrollerapisv1alpha1.Repository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ecrcontrollerapisv1alpha1.Repository{}, f.defaultInformer)
}

func (f *repositoryInformer) Lister() apisv1alpha1.RepositoryLister {
	return apisv1alpha1.NewRepositoryLister(f.Informer().GetIndexer())
}
